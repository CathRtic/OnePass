...
try:
    ...
    def refresh_list(scrollable_frame, master_password, root, search_query=""):
    ...
    def on_search(event=None):
        ...
        refresh_list(scrollable_frame, master_password, root, search_query)
...
# Main Page
search_entry = ctk.CTkEntry(main, placeholder_text="Search Service")
search_entry.grid(row=0, column=0, columnspan=2, sticky="nsew", padx=20, pady=5)
search_entry.bind("<KeyRelease>", on_search)

scrollable_frame = ctk.CTkScrollableFrame(main)
scrollable_frame.grid(row=1, column=0, columnspan=2, sticky="ew", padx=20, pady=10)
